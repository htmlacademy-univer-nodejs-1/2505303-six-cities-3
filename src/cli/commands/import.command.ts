...
export class ImportCommand implements Command {
  ...
  private async saveOffer(offer: Offer) {
    ...
    await this.offerService.create({
      ...
      placeImages: offer.images,
      isPremium: offer.isPremium,
      isFavorited: offer.isFavorite,
      rating: offer.rating,
      placeType: offer.type,
      countOfRooms: offer.numberRooms,
      countOfGuests: offer.numberGuests,
      rentPrice: offer.price,
      facilities: offer.conveniences,
      author: offer.author,
      countOfComments: offer.commentsCount,
